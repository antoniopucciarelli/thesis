\begin{figure}[!h]
    ...
    \begin{center} 
        ...
        \begin{tikzpicture}
            \begin{axis}[
                width=1.2\textwidth, % Increased width
            ...
            \addplot[black, line width=2pt] table[x index=0, y index=1, col sep=comma] {./images/csv/coords.csv};
            \addplot[black, line width=2pt] table[x index=2, y index=3, col sep=comma] {./images/csv/coords.csv};
            ...
            \draw[-, line width=1.0pt] (axis cs:-0.25,0.55) -- node[below] {$\alpha_1$} (axis cs:0.2, 0.55);
            \draw[-, line width=1.0pt] (axis cs:1.02,1) -- node[above left] {$\alpha_2$} (axis cs:1.6, 1);
