\begin{figure}[!ht]
    \vspace{-0.6cm}
    \centering
    \begin{tikzpicture}[font=\fontsize{4}{4}\ttfamily, thick, align=center, node distance=0.35cm, remember picture, x=\textwidth, y=\textheight]
    ...
    \coordinate[right=4cm of dimCheck] (controlPoint) {};
    ...
    \coordinate[left=1.3cm of convCheck]  (c1)                            {};
    \coordinate[]                         (c2) at (c1 |- costComputation) {};
    \coordinate[right=1cm of convCheck] (c3)                            {};
    \coordinate[below=0.35cm of convCheck] (c4)                            {};
    \coordinate[right=1cm of dimCheck] (c5) {};
    \coordinate[] (c6) at (c5 |- convCheck.north) {};
    \coordinate[right=1.5cm of convCheck] (c7) {};
